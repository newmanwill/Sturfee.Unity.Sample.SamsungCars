...
This scene represents how XRSession can be initialized for any iOS device. Notice the ProviderSet in SturfeeXRSession inspector is set to `IOS/Sensor Providers Set`.
...
*Note* : This scene is designed to run only on an Iphone. Running it in editor will lead to errors or crashes.
