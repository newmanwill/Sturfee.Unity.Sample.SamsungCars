...
This scene represents how XRSession can be initialized with ArKit. Notice the ProviderSet in SturfeeXRSession inspector is set to `IOS/ArKit Provider Set`.
